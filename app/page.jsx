...
export default function HomePage() {
  return (
    <div className="space-y-6 p-6">
      <h2 className="text-2xl font-bold" style={{ color: '#06b38d' }}>Bem-vindo</h2>
      ...
      <h3 className="text-xl font-semibold" style={{ color: '#06b38d' }}>O Problema que Resolvemos</h3>
      <p className="text-white">
      ...
      <h3 className="text-xl font-semibold" style={{ color: '#06b38d' }}>Nossa Solução</h3>
      ...
      <blockquote className="border-l-4 pl-4 italic text-gray-300" style={{ borderColor: '#06b38d' }}>
